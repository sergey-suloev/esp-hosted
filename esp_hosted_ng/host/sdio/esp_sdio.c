				  ...
				  const struct sdio_device_id *id)
{
	...
	esp_dbg("ESP-SDIO driver probe complete\n");
...
static const struct of_device_id esp_sdio_dt_ids[] = {
	{ .compatible = "espressif,esp32-sdio" },
	{ /* sentinel */ }
};
MODULE_DEVICE_TABLE(of, esp_sdio_dt_ids);
...
static struct sdio_driver esp_sdio_driver = {
	.drv = {
		.name = "esp32_sdio",
		.pm = &esp_pm_ops,
		.of_match_table = of_match_ptr(esp_sdio_dt_ids),
	},
	.name		= "esp32_sdio",
